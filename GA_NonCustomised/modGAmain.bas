...
PopuMain.NoOfDied = 0
Dim MaxFitnessVal, i As Long 'Max fitness in current population
Dim MinFitnessVal As Long 'Min fitness in current population
Dim SumFitness As Long ' Total sum of fitness
...
Next i
'FitLim = PopuMain.MaxFitness - (MaxFitnessVal - MinFitnessVal) ' Calculate the fitness limit
PopuMain.FitLim = SumFitness / PopuMain.NumOfIndivid
'Debug.Print "Max = " & MaxFitnessVal & vbCrLf & "Min = " & MinFitnessVal & vbCrLf
'Debug.Print "Diff = " & MaxFitnessVal - MinFitnessVal
For i = 1 To PopuMain.NumOfIndivid ' Calculte maximum and minimum fitness
    DoEvents
...
For i = 1 To Int(PopuMain.NumOfIndivid) ' Mutate All
    DoEvents
